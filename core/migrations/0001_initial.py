    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_option', models.CharField(choices=[('cash', 'Cash'), ('card', 'Card')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Room',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='payment_booking', to='core.booking')),
            ],
        ),
        migrations.CreateModel(
            name='Manager',
